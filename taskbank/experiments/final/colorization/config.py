...
def get_cfg( nopause=False ):
    ...
    # model
    cfg['model_type'] = architectures.EDSoftmaxRegenCGAN
    cfg['n_g_steps_before_d'] = 1
    cfg['n_d_steps_after_g'] = 1
    cfg['init_g_steps'] = 25000
    cfg['l_norm_weight_prop'] = 0.99
    ...
    cfg['decoder'] = decoder_fc_15_layer_64_resolution_16x16
    cfg['decoder_kwargs'] = {
    ...
    cfg['input_preprocessing_fn'] = load_ops.to_light
    ...
    # outputs
    cfg['target_num_channels'] = 313
    cfg['target_dim'] = (64, 64)  # (1024, 1024)
