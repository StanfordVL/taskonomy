...
DST_TASKS="autoencoder colorization curvature denoise edge2d edge3d \
ego_motion fix_pose impainting_whole keypoint2d keypoint3d \
...
segmentsemantic_rb"
DST_TASKS="autoencoder colorization curvature denoise edge2d edge3d \
ego_motion fix_pose keypoint2d \
non_fixated_pose point_match rgb2depth rgb2mist \
room_layout segment2d \
segmentsemantic_rb"
COUNTER=0
