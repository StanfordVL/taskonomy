...
INTERMEDIATE_TASKS="pose6 pose5 alex poseMatch cmu lsm"
...
DST_TASKS="curvature edge3d \
ego_motion rgb2depth rgb2sfnorm \
room_layout segment25d \
segmentsemantic_rb class_1000"
DST_TASKS="segment25d segmentsemantic_rb"
# DST tasks left out
# point_match 
