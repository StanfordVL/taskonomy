...
class_1000__class_selected__class_places__8__unlocked \
...
#INTERMEDIATE_TASKS="curvature__rgb2sfnorm__segmentsemantic_rb__8__unlocked \
...
#rgb2sfnorm__class_places__segmentsemantic_rb__8__unlocked \
...
export INSTANCE_TAG="x --config second_order/${decode}/$DATA_USED/${intermediate} --vid 4";
