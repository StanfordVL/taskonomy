...
INTERMEDIATE_TASKS="autoencoder curvature denoise edge2d edge3d colorization jigsaw \
keypoint2d keypoint3d reshade rgb2depth rgb2mist rgb2sfnorm segment25d segment2d \
segmentsemantic_rb class_places class_1000 vanishing_point_well_defined room_layout"
...
export INSTANCE_TAG="x --config final/${intermediate} --vid 4 --low-sat";
