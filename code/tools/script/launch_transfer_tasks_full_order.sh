...
export INSTANCE_TAG="full_order/${TARGET_DECODER_FUNCS}/$DATA_USED/FULL__${intermediate}__8__unlocked";
...
for intermediate in $INTERMEDIATE_TASKS; do
    ...
    then
        ...
        ECHO_OPTIONS="-D"
                ...
                USER_DATA=$(base64 $OPTIONS << END_USER_DATA
export HOME="/home/ubuntu"
export INSTANCE_TAG="full_order_image/${TARGET_DECODER_FUNCS}/$DATA_USED/FULL__${intermediate}__8__unlocked";
