...
def get_cfg( nopause=False ):
    ...
    cfg['encoder_kwargs'] = {
        'side_encoder_func' : side_encoder_with_dilated_conv_shallow,
    ...
    if transitive:
        if SAVE_TO_S3:
            log_root = '/home/ubuntu/s3/experiment_models/pix_stream_transfer_transitive_{}/dilated_shallow/{}/{}'.format(cfg['hidden_size'], INPUT_TASK, TARGET_TASK)
        else:
            log_root = '/home/ubuntu/experiment_models/pix_stream_transfer_transitive_{}/dilated_shallow/{}/{}'.format(cfg['hidden_size'], INPUT_TASK, TARGET_TASK)
    else:
        if SAVE_TO_S3:
            log_root = '/home/ubuntu/s3/experiment_models/pix_stream_transfer_{}/dilated_shallow/{}/{}'.format(cfg['hidden_size'], INPUT_TASK, TARGET_TASK)
        else:
            log_root = '/home/ubuntu/experiment_models/pix_stream_transfer_{}/dilated_shallow/{}/{}'.format(cfg['hidden_size'], INPUT_TASK, TARGET_TASK)
