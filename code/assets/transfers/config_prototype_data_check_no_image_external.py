...
def get_cfg( nopause=False ):
    ...
    ## DATA LOADING
    # representations
    task_to_rep_shape = {'alex': [4096], 'cmu': [1024], 'poseMatch': [512], 'pose5': [512], 'pose6': [500], 'lsm': [64,13,13]}
    cfg['representation_dim'] = task_to_rep_shape[representation_task]
    ...
    cfg['encoder_kwargs'] = {
        ...
        'first_fc' : True,
        'resize_zoom' : representation_task == 'lsm'
