...
def get_cfg( nopause=False ):
    ...
    cfg['train_list_of_fileinfos'] = os.path.abspath( os.path.join( '/home/ubuntu/s3', 'meta/val_image_split_{}.npy'.format(VAL_DATA_USED)) )    
    cfg['val_list_of_fileinfos'] = os.path.abspath( os.path.join( '/home/ubuntu/s3', 'meta/test_image_split_0.npy'))     
    ...
    target_cfg['train_filenames'] = os.path.abspath( os.path.join( '/home/ubuntu/s3', 
