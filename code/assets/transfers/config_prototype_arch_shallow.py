...
def get_cfg( nopause=False ):
    ...
    if INPUT_TASK == 'pixels':
        ...
        raise NotImplementedError("Architecture variation experiments shouldn't involve non-pixels this one lololol")
    ...
    cfg['encoder_kwargs'] = {
        'side_encoder_func' : transfer_models.side_encoder_l2_shallow,
