...
ONLY_UPDATE_BN_VALS_START_STEP = 6545
...
def get_cfg( nopause=False ):
    ...
    ## SETUP MODEL
    # Transfer
    cfg['encoder'] = transfer_multilayer_conv_with_bn_input 
    ...
    def create_bn_decay_schedule():
        ...
        with tf.variable_scope("batchnorm_decay", reuse=False) as sc:
            ...
            return tf.train.piecewise_constant(
                global_step, 
                boundaries=[np.int32(0), np.int32(ONLY_UPDATE_BN_VALS_START_STEP)],
                values=[0.0, 0.99]
            )
    ...
    cfg['encoder_kwargs'] = {
        ...
        'batch_norm_decay': create_bn_decay_schedule,
    ...
    cfg['learning_rate_schedule_kwargs' ] = {
        'boundaries': [np.int64(0), np.int64(5000), np.int64(ONLY_UPDATE_BN_VALS_START_STEP)], # need to be int64 since global step is...
        'values': [cfg['initial_learning_rate'], cfg['initial_learning_rate']/10, 0]
    }
