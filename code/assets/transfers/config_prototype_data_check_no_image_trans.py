...
def get_cfg( nopause=False ):
    ...
    if PRE_INPUT_TASK and PRE_INPUT_TASK != "PRE_INPUT_TASK":
        representation_task = PRE_INPUT_TASK + '__' + INPUT_TASK + '__' +  '8__unlocked'
        representation_dir = '/home/ubuntu/s3/experiments/rep_only_taskonomy/DO_NOT_REPLACE_TARGET_DECODER/{}/{}/scratch'.format(VAL_DATA_USED, representation_task)
        transitive = True
    ...
    ## DATA LOADING
    # representations
    cfg['representation_dim'] = [16, 16, 16]
    ...
    ## SETUP MODEL
    # Transfer
    cfg['encoder'] = transfer_models.transfer_two_stream_with_bn_ends_l2l0_no_image_trans
